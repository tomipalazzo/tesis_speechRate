...
SAMPLE = TIMIT_df_by_record.phone_train[TIMIT_df_by_record.phone_train['sample_id'] == 'DR1_CJF0_SA1']
...
x, y = m1(SAMPLE, step_size=step_size*1600, window_size=window_size*16000, with_pau=with_pause)
#%%
plt.plot(x,y)

#%% Test m2
x, y = m2(SAMPLE, SR=16000) 

#%% Test m3
x,y = m3(SAMPLE, t=0, step = 1)
...
#%% DUMMY TEST
start = [0, 10000, 1000000]
stop = [1, 10001, 1000001]
dt = pd.DataFrame({'start':start, 'stop':stop})
x, y = m4(dt, T=20000, t_step=0.0001)
